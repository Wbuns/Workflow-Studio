...
export function AIDevelopmentPage({ activePage, activeWorkspace }: AIDevelopmentPageProps) {
  ...
  const [activeTab, setActiveTab] = useState<AIDevelopmentTab>("context");
  ...
  return (
    <>
      ...
      <nav className="ai-development-tabs" aria-label="AI Development sections">
      ...
      {activeTab === "snapshots" && (
        <section className="module-panel ai-tab-panel">
          <div className="ai-section-heading"><div><p className="eyebrow">Workspace History</p><h3>AI Snapshots</h3></div><button type="button" className="ai-inline-action" onClick={handleCreateSnapshot} disabled={!rootPath || isWorking}>Create Snapshot</button></div>
