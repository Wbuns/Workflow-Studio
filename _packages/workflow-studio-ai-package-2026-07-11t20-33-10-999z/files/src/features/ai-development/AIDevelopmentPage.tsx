      ...
      {activeTab === "package" && (
        <section className="module-panel ai-package-builder-panel ai-tab-panel">
          ...
          <div className="ai-package-counts">
            <div><span>Packageable</span><strong>{packageEligibility?.counts.packageable ?? 0}</strong></div>
            <div><span>Skipped safely</span><strong>{packageEligibility?.counts.skipped ?? 0}</strong></div>
            <div><span>Generated</span><strong>{packageEligibility?.counts.generated ?? 0}</strong></div>
            <div><span>Protected</span><strong>{packageEligibility?.counts.protected ?? 0}</strong></div>
          </div>
